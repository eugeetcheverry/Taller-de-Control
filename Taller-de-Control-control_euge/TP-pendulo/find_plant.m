...
%% Recorto los datos
t_start = 45.72;   % tiempo inicial
t_end   = 48.9;   % tiempo final
...
new_data = readtable('datos_modificados.csv');
...
%Polos de la transferencia continia
disp('Polos de P_c')
p = pole(P_c)

%Ceros de la transferencia continia
disp('Ceros de P_c')
p = zero(P_c)
